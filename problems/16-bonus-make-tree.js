...
***********************************************************************/
const findParent = function(categories, parent, obj) {
  ...
  return findParent(categories.slice(1), parent, obj);
}

const makeTree = (categories, parent, obj = {}) => {
  // your code here
  obj = findParent(categories, parent, obj);
  ...
  obj[keys[0]] = makeTree(categories, keys[0], obj[keys[0]]);

  if (keys.length > 1) {
    obj[keys.slice(1)[0]] = makeTree(categories, keys.slice(1)[0], obj[keys.slice(1)[0]]);
  }
